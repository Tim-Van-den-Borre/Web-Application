...
<style>
    .closeMessage {
        margin-left: 10px; color: white; font-weight: bold; float: right; font-size: 16px; cursor: pointer;
    }
    ...
    .message {
        padding: 5px; background-color: #108fc2; color: white; border-radius: 10px;
    }
</style>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2">
                        <div class="p-6">
                            ...
                            <div class="ml-12">
                                <div class="mt-2 text-gray-600 dark:text-gray-400 text-sm">
                                    For this website, the Laravel 8 Framework has been used.
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="p-6 border-t border-gray-200 dark:border-gray-700 md:border-l">
                            <div class="flex items-center">
                                ...
                                <div class="ml-4 text-lg leading-7 font-semibold text-gray-900 dark:text-white">Creator</div>
                            </div>

                            <div class="ml-12">
                                <div class="mt-2 text-gray-600 dark:text-gray-400 text-sm">
                                    My name is Tim Van den Borre, I'm a student and the creator of this website.
                                </div>
                            </div>
                        </div>
                    </div>
